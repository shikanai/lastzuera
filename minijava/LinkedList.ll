...
else12:                                           ; preds = %then7
  ...
  %tmp22 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([4 x i8]* @.formatting.string, i32 0, i32 0), i32 -555)
  ...
  %tmp31 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([4 x i8]* @.formatting.string, i32 0, i32 0), i32 -555)
  br label %cont11
...
entry0:
  ...
  %tmp25 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([4 x i8]* @.formatting.string, i32 0, i32 0), i32 10000000)
  ...
  %tmp40 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([4 x i8]* @.formatting.string, i32 0, i32 0), i32 10000000)
  ...
  %tmp63 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([4 x i8]* @.formatting.string, i32 0, i32 0), i32 %tmp61)
  ...
  %tmp69 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([4 x i8]* @.formatting.string, i32 0, i32 0), i32 %tmp67)
  %tmp70 = getelementptr [4 x i8]* @.formatting.string, i32 0, i32 0
  %tmp71 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([4 x i8]* @.formatting.string, i32 0, i32 0), i32 10000000)
  ...
  %tmp85 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([4 x i8]* @.formatting.string, i32 0, i32 0), i32 2220000)
  ...
  %tmp94 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([4 x i8]* @.formatting.string, i32 0, i32 0), i32 33300000)
  ...
  %tmp103 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([4 x i8]* @.formatting.string, i32 0, i32 0), i32 44440000)
  ret i32 0
}
