...
then1:                                            ; preds = %entry0
  ...
  %tmp8 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([4 x i8]* @.formatting.string, i32 0, i32 0), i32 1)
  br label %cont2

else3:                                            ; preds = %entry0
  %tmp9 = getelementptr [4 x i8]* @.formatting.string, i32 0, i32 0
  %tmp10 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([4 x i8]* @.formatting.string, i32 0, i32 0), i32 0)
  br label %cont2
...
then4:                                            ; preds = %cont2
  ...
  %tmp14 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([4 x i8]* @.formatting.string, i32 0, i32 0), i32 1)
  br label %cont5

else6:                                            ; preds = %cont2
  %tmp15 = getelementptr [4 x i8]* @.formatting.string, i32 0, i32 0
  %tmp16 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([4 x i8]* @.formatting.string, i32 0, i32 0), i32 0)
  br label %cont5
...
then7:                                            ; preds = %cont5
  ...
  %tmp20 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([4 x i8]* @.formatting.string, i32 0, i32 0), i32 1)
  br label %cont8

else9:                                            ; preds = %cont5
  %tmp21 = getelementptr [4 x i8]* @.formatting.string, i32 0, i32 0
  %tmp22 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([4 x i8]* @.formatting.string, i32 0, i32 0), i32 0)
  br label %cont8
...
then10:                                           ; preds = %cont8
  ...
  %tmp26 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([4 x i8]* @.formatting.string, i32 0, i32 0), i32 1)
  br label %cont11

else12:                                           ; preds = %cont8
  %tmp27 = getelementptr [4 x i8]* @.formatting.string, i32 0, i32 0
  %tmp28 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([4 x i8]* @.formatting.string, i32 0, i32 0), i32 0)
  br label %cont11
...
then13:                                           ; preds = %cont11
  ...
  %tmp32 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([4 x i8]* @.formatting.string, i32 0, i32 0), i32 1)
  br label %cont14

else15:                                           ; preds = %cont11
  %tmp33 = getelementptr [4 x i8]* @.formatting.string, i32 0, i32 0
  %tmp34 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([4 x i8]* @.formatting.string, i32 0, i32 0), i32 0)
  br label %cont14
...
then16:                                           ; preds = %cont14
  ...
  %tmp38 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([4 x i8]* @.formatting.string, i32 0, i32 0), i32 1)
  br label %cont17

else18:                                           ; preds = %cont14
  %tmp39 = getelementptr [4 x i8]* @.formatting.string, i32 0, i32 0
  %tmp40 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([4 x i8]* @.formatting.string, i32 0, i32 0), i32 0)
  br label %cont17

cont17:                                           ; preds = %else18, %then16
...
then19:                                           ; preds = %cont17
  ...
  %tmp44 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([4 x i8]* @.formatting.string, i32 0, i32 0), i32 1)
  br label %cont20

else21:                                           ; preds = %cont17
  %tmp45 = getelementptr [4 x i8]* @.formatting.string, i32 0, i32 0
  %tmp46 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([4 x i8]* @.formatting.string, i32 0, i32 0), i32 0)
  br label %cont20

cont20:                                           ; preds = %else21, %then19
...
then22:                                           ; preds = %cont20
  ...
  %tmp50 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([4 x i8]* @.formatting.string, i32 0, i32 0), i32 1)
  br label %cont23

else24:                                           ; preds = %cont20
  %tmp51 = getelementptr [4 x i8]* @.formatting.string, i32 0, i32 0
  %tmp52 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([4 x i8]* @.formatting.string, i32 0, i32 0), i32 0)
  br label %cont23
...
cont2:                                            ; preds = %while3
  %tmp15 = getelementptr [4 x i8]* @.formatting.string, i32 0, i32 0
  %tmp16 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([4 x i8]* @.formatting.string, i32 0, i32 0), i32 99999)
  ret i32 0
}
