...
entry0:
  ...
  %tmp35 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([4 x i8]* @.formatting.string, i32 0, i32 0), i32 100000000)
  ...
  %tmp39 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([4 x i8]* @.formatting.string, i32 0, i32 0), i32 50000000)
  ...
  %tmp46 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([4 x i8]* @.formatting.string, i32 0, i32 0), i32 100000000)
  ...
  %tmp66 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([4 x i8]* @.formatting.string, i32 0, i32 0), i32 %tmp64)
  ...
  %tmp71 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([4 x i8]* @.formatting.string, i32 0, i32 0), i32 %tmp69)
  ...
  %tmp82 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([4 x i8]* @.formatting.string, i32 0, i32 0), i32 %tmp80)
  ret i32 0
}
...
entry0:
  ...
  %tmp1 = call i32 (i8*, ...)* @printf(i8* getelementptr inbounds ([4 x i8]* @.formatting.string, i32 0, i32 0), i32 333)
...
entry0:
  ...
  store i8* bitcast (i32 (%class.MyVisitor*, %class.Tree*)* @__visit_MyVisitor to i8*), i8** %tmp3
  ret void
}
